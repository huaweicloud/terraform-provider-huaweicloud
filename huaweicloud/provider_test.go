...
var (
	...
	HW_CERTIFICATE_TARGET_SERVICE         = os.Getenv("HW_CERTIFICATE_TARGET_SERVICE")
	HW_CERTIFICATE_TARGET_SERVICE_UPDATED = os.Getenv("HW_CERTIFICATE_TARGET_SERVICE_UPDATED")
	HW_CERTIFICATE_TARGET_PROJECT         = os.Getenv("HW_CERTIFICATE_TARGET_PROJECT")
	HW_CERTIFICATE_TARGET_PROJECT_UPDATE  = os.Getenv("HW_CERTIFICATE_TARGET_PROJECT_UPDATE")
)

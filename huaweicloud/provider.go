...
func Provider() terraform.ResourceProvider {
	provider := &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"huaweicloud_compute_eip_associate_v2":           resourceComputeFloatingIPAssociateV2(),
			...
			"huaweicloud_networking_eip_associate_v2":        resourceNetworkingFloatingIPAssociateV2(),

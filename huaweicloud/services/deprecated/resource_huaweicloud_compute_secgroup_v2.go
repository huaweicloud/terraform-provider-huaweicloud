...
func SecGroupV2StateRefreshFunc(computeClient *golangsdk.ServiceClient, d *schema.ResourceData) retry.StateRefreshFunc {
	return func() (interface{}, string, error) {
		...
		if err != nil {
			err = common.CheckDeleted(d, err, "Security Group")
			if err != nil {
				return s, "", err
			} else {

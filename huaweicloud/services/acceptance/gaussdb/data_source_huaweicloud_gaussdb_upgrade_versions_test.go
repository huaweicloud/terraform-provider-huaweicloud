...
func TestAccDataSourceGaussDbUpgradeVersions_basic(t *testing.T) {
	dataSource := "data.huaweicloud_gaussdb_upgrade_versions.test"
...
data "huaweicloud_gaussdb_upgrade_versions" "test" {

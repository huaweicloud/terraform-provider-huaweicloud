...
func TestAccDataSourceGaussdbOpengaussPtApplicableInstances_basic(t *testing.T) {
	dataSource := "data.huaweicloud_gaussdb_opengauss_pt_applicable_instances.test"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testDataSourceGaussdbOpengaussPtApplicableInstances_basic(rName),
...
func testDataSourceGaussdbOpengaussPtApplicableInstances_base(name string) string {
	return fmt.Sprintf(`
%[1]s
...
func testDataSourceGaussdbOpengaussPtApplicableInstances_basic(name string) string {
	return fmt.Sprintf(`
%s
...
`, testDataSourceGaussdbOpengaussPtApplicableInstances_base(name))
}

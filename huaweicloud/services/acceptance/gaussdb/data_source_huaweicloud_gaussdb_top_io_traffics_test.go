...
func TestAccDataSourceGaussDbTopIoTraffics_basic(t *testing.T) {
	dataSource := "data.huaweicloud_gaussdb_top_io_traffics.test"
...
output "top_io_num_filter_is_useful" {
  value = length(data.huaweicloud_gaussdb_top_io_traffics.top_io_num_filter.top_io_infos) > 0
}
...
output "sort_condition_filter_is_useful" {
  value = length(data.huaweicloud_gaussdb_top_io_traffics.sort_condition_filter.top_io_infos) > 0
}

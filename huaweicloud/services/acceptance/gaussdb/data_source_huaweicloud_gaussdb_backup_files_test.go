...
func TestAccDataSourceGaussDbBackupFiles_basic(t *testing.T) {
	dataSource := "data.huaweicloud_gaussdb_backup_files.test"
...
data "huaweicloud_gaussdb_backup_files" "test" {

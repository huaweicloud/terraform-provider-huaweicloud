...
func TestAccOpenGaussEipAssociate_basic(t *testing.T) {
	...
	rName := "huaweicloud_gaussdb_eip_associate.test"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(rName, "node_id",
						"huaweicloud_gaussdb_instance.test", "nodes.0.id"),
...
resource "huaweicloud_gaussdb_eip_associate" "test"{
  instance_id  = huaweicloud_gaussdb_instance.test.id
  node_id      = huaweicloud_gaussdb_instance.test.nodes.0.id

...
output "limit_type_value_filter_is_useful" {
  value = length(data.huaweicloud_gaussdb_sql_throttling_tasks.limit_type_value_filter.limit_task_list) > 0 && alltrue(
  [for v in data.huaweicloud_gaussdb_sql_throttling_tasks.limit_type_value_filter.limit_task_list[*].limit_type_value :
...
output "task_name_filter_is_useful" {
  value = length(data.huaweicloud_gaussdb_sql_throttling_tasks.task_name_filter.limit_task_list) > 0
}
...
output "sql_model_filter_is_useful" {
  value = length(data.huaweicloud_gaussdb_sql_throttling_tasks.sql_model_filter.limit_task_list) > 0 && alltrue(
  [for v in data.huaweicloud_gaussdb_sql_throttling_tasks.sql_model_filter.limit_task_list[*].sql_model :
  v == local.sql_model]
  )
}
...
output "rule_name_filter_is_useful" {
  value = length(data.huaweicloud_gaussdb_sql_throttling_tasks.rule_name_filter.limit_task_list) > 0 && alltrue(
  [for v in data.huaweicloud_gaussdb_sql_throttling_tasks.rule_name_filter.limit_task_list[*].rule_name :
  v == local.rule_name]
  )
}
...
output "start_time_filter_is_useful" {
  value = length(data.huaweicloud_gaussdb_sql_throttling_tasks.start_time_filter.limit_task_list) > 0
}

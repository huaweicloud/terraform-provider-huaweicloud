...
func TestAccDataSourceGaussDbInstanceCoordinators_basic(t *testing.T) {
	dataSource := "data.huaweicloud_gaussdb_instance_coordinators.test"
...
data "huaweicloud_gaussdb_instance_coordinators" "test" {

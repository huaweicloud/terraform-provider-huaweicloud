...
func TestAccDataSourceGaussDbSolutionTemplateSetting_basic(t *testing.T) {
	dataSource := "data.huaweicloud_gaussdb_solution_template_setting.test"
	dataSourceWithInstanceId := "data.huaweicloud_gaussdb_solution_template_setting.test_instance_id"
...
data "huaweicloud_gaussdb_solution_template_setting" "test" {
  solution = "single"
}

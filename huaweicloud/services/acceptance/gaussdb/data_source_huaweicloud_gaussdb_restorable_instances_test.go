...
func TestAccDataSourceGaussDbRestorableInstances_basic(t *testing.T) {
	dataSource := "data.huaweicloud_gaussdb_restorable_instances.test"
...
data "huaweicloud_gaussdb_restorable_instances" "test" {

...
func TestAccV3UserProjects_basic(t *testing.T) {
	var (
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccV3UserProjects_basic(name),
...
func testAccV3UserProjects_base(name string) string {
	return fmt.Sprintf(`
...
func testAccV3UserProjects_basic(name string) string {
	return fmt.Sprintf(`
%[1]s
...
`, testAccV3UserProjects_base(name))
}

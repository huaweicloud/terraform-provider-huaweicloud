...
func TestAccDataSourceUsers_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceUsers_basic(name, password),
...
func testAccDataSourceUsers_base(name, password string) string {
	return fmt.Sprintf(`
...
resource "huaweicloud_workspace_user_group" "user_group_test" {
  name        = "Terraform_Test"
  type        = "LOCAL"
...
func testAccDataSourceUsers_basic(name, password string) string {
	return fmt.Sprintf(`
%[1]s
...
locals {
  ...
  group_name            = huaweicloud_workspace_user_group.user_group_test.name
...
}`, testAccDataSourceUsers_base(name, password))
}

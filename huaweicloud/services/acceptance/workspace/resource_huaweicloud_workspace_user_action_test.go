...
func TestAccUserAction_basic(t *testing.T) {
	var (
		...
		resourceName = "huaweicloud_workspace_user_action.test"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(resourceName, "op_type", "LOCK"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(resourceName, "op_type", "UNLOCK"),
					resource.TestCheckResourceAttrSet(resourceName, "user_id"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(resourceName, "op_type", "RESET_PWD"),
					resource.TestCheckResourceAttrSet(resourceName, "user_id"),
				),
			},
		},

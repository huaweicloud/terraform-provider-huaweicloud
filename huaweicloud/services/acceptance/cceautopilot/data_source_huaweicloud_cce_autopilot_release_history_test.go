...
func TestAccDataSourceCCEAutopilotReleaseHistory_basic(t *testing.T) {
	dataSource := "data.huaweicloud_cce_autopilot_release_history.test"
...
locals {
  release_name = data.huaweicloud_cce_autopilot_releases.namespace_filter.releases[0].name
}

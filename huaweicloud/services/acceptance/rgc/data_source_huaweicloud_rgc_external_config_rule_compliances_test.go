...
func TestAccDataSourceExternalConfigRuleCompliances_basic(t *testing.T) {
	dataSource := "data.huaweicloud_rgc_external_config_rule_compliances.test"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceExternalConfigRuleCompliances_basic(),
...
func testAccDataSourceExternalConfigRuleCompliances_basic() string {
	return fmt.Sprintf(`

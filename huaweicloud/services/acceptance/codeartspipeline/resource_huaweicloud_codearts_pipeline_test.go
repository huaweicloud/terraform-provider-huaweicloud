		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(rName, "sources.0.type", "code"),
					resource.TestCheckResourceAttrPair(rName, "sources.0.params.0.codehub_id", "huaweicloud_codearts_repository.test", "id"),
					resource.TestCheckResourceAttrPair(rName, "sources.0.params.0.git_url", "huaweicloud_codearts_repository.test", "https_url"),
					resource.TestCheckResourceAttrPair(rName, "sources.0.params.0.ssh_git_url", "huaweicloud_codearts_repository.test", "ssh_url"),
					resource.TestCheckResourceAttrPair(rName, "sources.0.params.0.repo_name", "huaweicloud_codearts_repository.test", "name"),
					resource.TestCheckResourceAttr(rName, "sources.0.params.0.git_type", "codehub"),
					resource.TestCheckResourceAttr(rName, "sources.0.params.0.default_branch", "master"),
					resource.TestCheckResourceAttrPair(rName, "triggers.0.git_url", "huaweicloud_codearts_repository.test", "https_url"),
					resource.TestCheckResourceAttrPair(rName, "triggers.0.repo_id", "huaweicloud_codearts_repository.test", "id"),
					resource.TestCheckResourceAttr(rName, "triggers.0.git_type", "codehub"),
					resource.TestCheckResourceAttr(rName, "triggers.0.is_auto_commit", "false"),
					resource.TestCheckResourceAttrSet(rName, "triggers.0.events.#"),
					resource.TestCheckResourceAttr(rName, "schedules.0.type", "periodic"),
					resource.TestCheckResourceAttr(rName, "schedules.0.name", "test"),
					resource.TestCheckResourceAttr(rName, "schedules.0.enable", "true"),
					resource.TestCheckResourceAttrSet(rName, "schedules.0.days_of_week.#"),
					resource.TestCheckResourceAttr(rName, "schedules.0.time_zone", "China Standard Time"),
					resource.TestCheckResourceAttr(rName, "schedules.0.start_time", "18:51"),
					resource.TestCheckResourceAttr(rName, "schedules.0.end_time", "19:27"),
					resource.TestCheckResourceAttr(rName, "concurrency_control.0.concurrency_number", "5"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(rName, "triggers.0.events.#"),
					resource.TestCheckResourceAttr(rName, "schedules.0.type", "periodic"),
					resource.TestCheckResourceAttr(rName, "schedules.0.name", "test_update"),
					resource.TestCheckResourceAttr(rName, "schedules.0.enable", "true"),
					resource.TestCheckResourceAttrSet(rName, "schedules.0.days_of_week.#"),
					resource.TestCheckResourceAttr(rName, "schedules.0.time_zone", "China Standard Time"),
					resource.TestCheckResourceAttr(rName, "schedules.0.start_time", "18:51"),
					resource.TestCheckResourceAttr(rName, "schedules.0.end_time", "19:27"),
					resource.TestCheckResourceAttr(rName, "concurrency_control.0.concurrency_number", "5"),
					resource.TestCheckResourceAttr(rName, "variables.0.name", "test_var_update"),
					resource.TestCheckResourceAttr(rName, "variables.0.type", "string"),
					resource.TestCheckResourceAttr(rName, "variables.0.value", "test_value"),
				),
			},

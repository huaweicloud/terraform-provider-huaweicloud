...
func TestAccDataSourceVolumesByTags_basic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataTagsVolumesByTags_basic1(testName),
			...
			{
				Config: testAccDataTagsVolumesByTags_basic2(testName),
				Check: resource.ComposeTestCheckFunc(
...
func testAccDataVolumesByTags_base(name string) string {
	return fmt.Sprintf(`
...
func testAccDataTagsVolumesByTags_basic1(name string) string {
	return fmt.Sprintf(`
%[1]s
...
}`, testAccDataVolumesByTags_base(name))
}

func testAccDataTagsVolumesByTags_basic2(name string) string {
	return fmt.Sprintf(`
%[1]s
...
}`, testAccDataVolumesByTags_base(name), name)
}

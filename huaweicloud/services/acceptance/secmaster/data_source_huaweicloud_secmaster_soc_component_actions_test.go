...
func TestAccDataSourceSocComponentActions_basic(t *testing.T) {
	var (
		dataSource = "data.huaweicloud_secmaster_soc_component_actions.test"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testDataSourceSocComponentActions_basic(),
...
func testDataSourceSocComponentActions_basic() string {
	return fmt.Sprintf(`

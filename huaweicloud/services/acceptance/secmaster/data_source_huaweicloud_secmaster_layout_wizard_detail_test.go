...
func TestAccDataSourceLayoutWizardDetail_basic(t *testing.T) {
	var (
		dataSource = "data.huaweicloud_secmaster_layout_wizard_detail.test"
	...
	resource.ParallelTest(t, resource.TestCase{
		PreCheck: func() {
			...
			acceptance.TestAccPreCheckSecMasterFieldId(t)
		},
		ProviderFactories: acceptance.TestAccProviderFactories,
		Steps: []resource.TestStep{
			{
				Config: testDataSourceLayoutWizardDetail_basic(),
...
func testDataSourceLayoutWizardDetail_basic() string {
	return fmt.Sprintf(`
...
`, acceptance.HW_SECMASTER_WORKSPACE_ID, acceptance.HW_SECMASTER_LAYOUT_ID, acceptance.HW_SECMASTER_FIELD_ID)
}

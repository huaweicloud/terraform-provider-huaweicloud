...
func TestAccDataSourcePlaybookInstance_basic(t *testing.T) {
	var (
		dataSource = "data.huaweicloud_secmaster_playbook_instance.test"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testDataSourcePlaybookInstance_basic(),
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(dataSource, "playbook.0.version"),
...
func testDataSourcePlaybookInstance_basic() string {
	return fmt.Sprintf(`

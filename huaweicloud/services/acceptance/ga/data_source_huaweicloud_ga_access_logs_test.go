		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(dataSourceName, "logs.0.rsource_type"),
					...
					resource.TestCheckResourceAttrSet(dataSourceName, "logs.0.created_at"),
					resource.TestCheckResourceAttrSet(dataSourceName, "logs.0.updated_at"),

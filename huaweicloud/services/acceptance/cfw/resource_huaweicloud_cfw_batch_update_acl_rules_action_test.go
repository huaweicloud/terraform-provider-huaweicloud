...
func TestAccBatchUpdateAclRulesAction_basic(t *testing.T) {
	// lintignore:AT001
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testBatchUpdateAclRulesAction_basic(),
			},
		},
	})
}

func testBatchUpdateAclRulesAction_base() string {
	return fmt.Sprintf(`
...
func testBatchUpdateAclRulesAction_basic() string {
	return fmt.Sprintf(`
%[1]s
...
`, testBatchUpdateAclRulesAction_base(), acceptance.HW_CFW_ACL_RULE_ID, acceptance.HW_CFW_INSTANCE_ID,

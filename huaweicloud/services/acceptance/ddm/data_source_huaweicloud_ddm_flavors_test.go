		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(rName, "flavors.#", "3"),
					resource.TestCheckResourceAttr(rName, "flavors.0.type_code", "hws.resource.type.ddm"),
					resource.TestCheckResourceAttr(rName, "flavors.0.code", "ddm.c6.2xlarge.2"),
					resource.TestCheckResourceAttr(rName, "flavors.0.iaas_code", "c6s.2xlarge.2"),
				),
			},
		},
	})

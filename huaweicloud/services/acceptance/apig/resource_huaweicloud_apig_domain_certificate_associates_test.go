...
func TestAccDomainCertificateAssociate_basic(t *testing.T) {
	var (
		...
		withoutRootCA          = "huaweicloud_apig_domain_certificate_associate.without_root_ca"
		rcWithoutRootCA        = acceptance.InitResourceCheck(withoutRootCA, &associatedCertificates, getDomainCertificateAssociateFunc)
	)
...
resource "huaweicloud_apig_domain_certificate_associate" "without_root_ca" {
  instance_id     = "%[2]s"
  group_id        = huaweicloud_apig_group.test.id

		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestMatchResourceAttr(dataSourceName, "dimensions.#", regexp.MustCompile(`^[1-9]\d*$`)),
					resource.TestCheckResourceAttrSet(dataSourceName, "dimensions.0.name"),
					resource.TestMatchResourceAttr(dataSourceName, "dimensions.0.metrics.#", regexp.MustCompile(`^[1-9]\d*$`)),
					resource.TestMatchResourceAttr(dataSourceName, "dimensions.0.key_name.#", regexp.MustCompile(`^[1-9]\d*$`)),
					resource.TestMatchResourceAttr(dataSourceName, "dimensions.0.dim_router.#", regexp.MustCompile(`^[1-9]\d*$`)),
					resource.TestMatchResourceAttr(dataSourceName, "instance_ids.#", regexp.MustCompile(`^[1-9]\d*$`)),
					resource.TestCheckResourceAttrSet(dataSourceName, "instance_ids.0.name"),
					resource.TestMatchResourceAttr(dataSourceName, "nodes.#", regexp.MustCompile(`^[1-9]\d*$`)),
					resource.TestCheckResourceAttrSet(dataSourceName, "nodes.0.name"),
					resource.TestMatchResourceAttr(dataSourceName, "queues.#", regexp.MustCompile(`^[1-9]\d*$`)),
					resource.TestCheckResourceAttrSet(dataSourceName, "queues.0.name"),
					resource.TestMatchResourceAttr(dataSourceName, "queues.0.partitions.#", regexp.MustCompile(`^[1-9]\d*$`)),
					resource.TestCheckResourceAttrSet(dataSourceName, "queues.0.partitions.0.name"),
					resource.TestMatchResourceAttr(dataSourceName, "groups.#", regexp.MustCompile(`^[1-9]\d*$`)),
					resource.TestCheckResourceAttrSet(dataSourceName, "groups.0.name"),
					resource.TestMatchResourceAttr(dataSourceName, "groups.0.queues.#", regexp.MustCompile(`^[1-9]\d*$`)),
					resource.TestCheckResourceAttrSet(dataSourceName, "groups.0.queues.0.name"),
					resource.TestMatchResourceAttr(dataSourceName, "groups.0.queues.0.partitions.#", regexp.MustCompile(`^[1-9]\d*$`)),

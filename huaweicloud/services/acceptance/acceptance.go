...
var (
	...
	HW_IDENTITY_CENTER_PORTAL_URL                = os.Getenv("HW_IDENTITY_CENTER_PORTAL_URL")
	HW_IDENTITY_CENTER_VERIFIED_DEVICE_CODE      = os.Getenv("HW_IDENTITY_CENTER_VERIFIED_DEVICE_CODE")
	HW_IDENTITY_CENTER_CLIENT_ID                 = os.Getenv("HW_IDENTITY_CENTER_CLIENT_ID")
	HW_IDENTITY_CENTER_CLIENT_SECRET             = os.Getenv("HW_IDENTITY_CENTER_CLIENT_SECRET")

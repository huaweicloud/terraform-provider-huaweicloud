...
var (
	...
	HW_COC_SCRIPT_ORDER_ID = os.Getenv("HW_COC_SCRIPT_ORDER_ID")
...
// lintignore:AT003
func TestAccPreCheckCocScriptOrderID(t *testing.T) {
	if HW_COC_SCRIPT_ORDER_ID == "" {
		t.Skip("HW_COC_SCRIPT_ORDER_ID must be set for the acceptance test")
	}
}

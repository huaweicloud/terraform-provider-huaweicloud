...
// lintignore:AT003
func TestAccPreCheckDMSRocketMQDeadLetterMessageIDs(t *testing.T) {
	if HW_DMS_ROCKETMQ_DEAD_LETTER_MESSAGE_IDs == "" {
		t.Skip("HW_DMS_ROCKETMQ_DEAD_LETTER_MESSAGE_IDs must be set for DMS RocketMQ dead letter messages acceptance test")
	}
}

...
var (
	...
	HW_HSS_ENABLE_FLAG = os.Getenv("HW_HSS_ENABLE_FLAG")
...
// lintignore:AT003
func TestAccPreCheckHSSFlag(t *testing.T) {
	if HW_HSS_ENABLE_FLAG == "" {
		t.Skip("HW_HSS_ENABLE_FLAG must be set for the acceptance test")
	}
}

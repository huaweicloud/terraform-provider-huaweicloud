...
var (
	...
	HW_EG_OFFICIAL_CHANNEL_NAME = os.Getenv("HW_EG_OFFICIAL_CHANNEL_NAME")
...
// lintignore:AT003
func TestAccPreCheckEgOfficialChannelName(t *testing.T) {
	if HW_EG_OFFICIAL_CHANNEL_NAME == "" {
		t.Skip("The sub-resource acceptance test of the EG official channel must set 'HW_EG_OFFICIAL_CHANNEL_NAME'")
	}
}

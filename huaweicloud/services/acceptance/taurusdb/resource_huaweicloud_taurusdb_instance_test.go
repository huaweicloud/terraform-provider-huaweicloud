...
func TestAccTaurusDBInstance_basic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccTaurusDBInstanceConfig_basic(name),
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(resourceName, "configuration_name",
						"huaweicloud_taurusdb_parameter_template.test.0", "name"),
					...
					resource.TestCheckResourceAttrPair(resourceName, "auto_scaling.0.max_flavor",
						"data.huaweicloud_taurusdb_flavors.test", "flavors.2.name"),
			...
			{
				Config: testAccTaurusDBInstanceConfig_basicUpdate(updateName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckTaurusDBInstanceExists(resourceName, &instance),
					...
					resource.TestCheckResourceAttrPair(resourceName, "configuration_name",
						"huaweicloud_taurusdb_parameter_template.test.1", "name"),
...
func TestAccTaurusDBInstance_prePaid(t *testing.T) {
	var (
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccTaurusDBInstanceConfig_prePaid(rName, password, false),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckTaurusDBInstanceExists(resourceName, &instance),
			...
			{
				Config: testAccTaurusDBInstanceConfig_prePaid(rName, password, true),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckTaurusDBInstanceExists(resourceName, &instance),
...
func TestAccTaurusDBInstance_updateWithEpsId(t *testing.T) {
	var instance instances.TaurusDBInstance
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccTaurusDBInstanceConfig_withEpsId(rName, srcEPS),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckTaurusDBInstanceExists(resourceName, &instance),
			...
			{
				Config: testAccTaurusDBInstanceConfig_withEpsId(rName, destEPS),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckTaurusDBInstanceExists(resourceName, &instance),
					resource.TestCheckResourceAttr(resourceName, "name", rName),
...
func TestAccTaurusDBInstance_single(t *testing.T) {
	var instance instances.TaurusDBInstance
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccTaurusDBInstanceConfig_single(name),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckTaurusDBInstanceExists(resourceName, &instance),
					resource.TestCheckResourceAttr(resourceName, "name", name),
...
func testAccTaurusDBInstanceConfig_base(rName string) string {
	return fmt.Sprintf(`
%[1]s
...
func testAccTaurusDBInstanceConfig_basic(rName string) string {
	return fmt.Sprintf(`
%[1]s
...
resource "huaweicloud_taurusdb_instance" "test" {
  ...
  auto_scaling {
    ...
    max_flavor          = data.huaweicloud_taurusdb_flavors.test.flavors[2].name
    reduce_enabled      = true
...
func testAccTaurusDBInstanceConfig_basicUpdate(rName string) string {
	return fmt.Sprintf(`
%[1]s
...
resource "huaweicloud_taurusdb_instance" "test" {
  ...
  flavor                   = data.huaweicloud_taurusdb_flavors.test.flavors[1].name
  vpc_id                   = huaweicloud_vpc.test.id
  subnet_id                = huaweicloud_vpc_subnet.test.id
...
func testAccTaurusDBInstanceConfig_prePaid(rName, password string, isAutoRenew bool) string {
	return fmt.Sprintf(`
%s
...
func testAccTaurusDBInstanceConfig_withEpsId(rName, epsId string) string {
	return fmt.Sprintf(`
%s
...
func testAccTaurusDBInstanceConfig_single(rName string) string {
	return fmt.Sprintf(`
%[1]s

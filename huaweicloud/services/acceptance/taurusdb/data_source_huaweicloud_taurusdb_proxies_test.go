...
func TestAccDataSourceTaurusDBProxies_basic(t *testing.T) {
	dataSource := "data.huaweicloud_taurusdb_proxies.test"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testDataSourceDataSourceTaurusDBProxies_basic(rName),
...
func testDataSourceDataSourceTaurusDBProxies_base(name string) string {
	return fmt.Sprintf(`
%s
...
func testDataSourceDataSourceTaurusDBProxies_basic(name string) string {
	return fmt.Sprintf(`
%s

data "huaweicloud_taurusdb_proxies" "test" {
  depends_on = [huaweicloud_taurusdb_proxy.test]

  instance_id = huaweicloud_taurusdb_instance.test.id
}
`, testDataSourceDataSourceTaurusDBProxies_base(name))
}

...
func TestAccDataSourceTaurusDBAutoScalingRecords_basic(t *testing.T) {
	dataSource := "data.huaweicloud_taurusdb_auto_scaling_records.test"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testDataSourceTaurusDBAutoScalingRecords_basic(rName),
...
func testDataSourceTaurusDBAutoScalingRecords_basic(name string) string {
	return fmt.Sprintf(`
%[1]s

...
func TestAccDataSourceTaurusDBDatabaseCharacterSet_basic(t *testing.T) {
	dataSource := "data.huaweicloud_taurusdb_database_character_set.test"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testDataSourceDataSourceTaurusDBDatabaseCharacterSet_basic(rName),
...
func testDataSourceDataSourceTaurusDBDatabaseCharacterSet_basic(name string) string {
	return fmt.Sprintf(`
%[1]s

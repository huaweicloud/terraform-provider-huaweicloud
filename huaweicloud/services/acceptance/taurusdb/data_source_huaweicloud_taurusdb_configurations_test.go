...
func TestAccDataSourceTaurusDBConfigurations_basic(t *testing.T) {
	dataSource := "data.huaweicloud_taurusdb_configurations.test"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testDataSourceDataSourceTaurusDBConfigurations_basic(),
...
func testDataSourceDataSourceTaurusDBConfigurations_basic() string {
	return `
data "huaweicloud_taurusdb_configurations" "test" {}
`
}

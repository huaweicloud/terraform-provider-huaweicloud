...
func getTaurusDBMySQLInstance(cfg *config.Config, state *terraform.ResourceState) (interface{}, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("error retrieving TaurusDB instance: %s", err)
	}
	...
	if instance == nil {
		return nil, errors.New("error getting TaurusDB instance")
	}

	return instance, nil
}

func TestAccTaurusDBTemplateApply_basic(t *testing.T) {
	var obj interface{}
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccTaurusDBTemplateApply_apply(rName),
...
func testAccTaurusDBTemplateApply_apply(rName string) string {
	return fmt.Sprintf(`
%[1]s
...
resource "huaweicloud_taurusdb_parameter_template_apply" "test" {

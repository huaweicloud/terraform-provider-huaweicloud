...
func TestAccDataSourceTaurusDBProxyFlavors_basic(t *testing.T) {
	dataSource := "data.huaweicloud_taurusdb_proxy_flavors.test"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testDataSourceTaurusDBProxyFlavors_basic(rName),
...
func testDataSourceTaurusDBProxyFlavors_base(rName string) string {
	return fmt.Sprintf(`
%s
...
func testDataSourceTaurusDBProxyFlavors_basic(name string) string {
	return fmt.Sprintf(`
%s
...
`, testDataSourceTaurusDBProxyFlavors_base(name))
}

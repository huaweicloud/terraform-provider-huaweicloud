...
func TestAccDataSourceTaurusDBRecyclingInstances_basic(t *testing.T) {
	dataSource := "data.huaweicloud_taurusdb_recycling_instances.test"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testDataSourceTaurusDBRecyclingInstances_basic(),
...
func testDataSourceTaurusDBRecyclingInstances_basic() string {
	return `

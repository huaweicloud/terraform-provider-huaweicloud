...
func TestAccTaurusDBHtapStarrocksReplicationResume_basic(t *testing.T) {
	var obj interface{}
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccTaurusDBHtapStarrocksReplicationResume_basic(rName),
...
func testAccTaurusDBHtapStarrocksReplicationResume_basic(name string) string {
	return fmt.Sprintf(`
%s
...
resource "huaweicloud_taurusdb_htap_starrocks_replication_resume" "test" {
  ...
  depends_on = [huaweicloud_taurusdb_htap_starrocks_replication_pause.test]
}
`, testAccTaurusDBHtapStarrocksReplicationPause_basic(name))
}

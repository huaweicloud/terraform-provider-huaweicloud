...
func TestAccDcsMigrationTaskStop_basic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testDcsMigrationTaskStop_basic(name),
			},
		},
	})
}

func testDcsMigrationTaskStop_base(name string) string {
	return fmt.Sprintf(`
...
func testDcsMigrationTaskStop_basic(name string) string {
	return fmt.Sprintf(`
%s
...
`, testDcsMigrationTaskStop_base(name))
}

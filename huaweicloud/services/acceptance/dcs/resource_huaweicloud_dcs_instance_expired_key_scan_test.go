...
func getInstanceExpiredKeyScanFunc(cfg *config.Config, state *terraform.ResourceState) (interface{}, error) {
...
func TestAccInstanceExpiredKeyScan_basic(t *testing.T) {
	var obj interface{}
	name := acceptance.RandomAccResourceName()
	rName := "huaweicloud_dcs_instance_expired_key_scan.test"

	rc := acceptance.InitResourceCheck(
		rName,
		&obj,
		getInstanceExpiredKeyScanFunc,
	)
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testInstanceExpiredKeyScan_basic(name),
...
func testInstanceExpiredKeyScan_base(name string) string {
	return fmt.Sprintf(`
...
func testInstanceExpiredKeyScan_basic(name string) string {
	return fmt.Sprintf(`
%s
...
`, testInstanceExpiredKeyScan_base(name))
}

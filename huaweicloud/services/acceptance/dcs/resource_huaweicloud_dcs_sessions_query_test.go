...
func TestAccDcsSessionsQuery_basic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDcsSessionsQuery_basic(name),
			},
		},
	})
}

func testAccDcsSessionsQuery_base(name string) string {
	return fmt.Sprintf(`
...
func testAccDcsSessionsQuery_basic(name string) string {
	return fmt.Sprintf(`
%s

...
func TestAccDcsMigrationTaskExchangeIp_basic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testDcsMigrationTaskExchangeIp_basic(name),
			},
		},
	})
}

func testDcsMigrationTaskExchangeIp_base(name string) string {
	return fmt.Sprintf(`
...
func testDcsMigrationTaskExchangeIp_basic(name string) string {
	return fmt.Sprintf(`
%s
...
`, testDcsMigrationTaskExchangeIp_base(name))
}

...
func TestAccDcsAllSessionsKill_basic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDcsAllSessionsKill_basic(name),
			},
		},
	})
}

func testAccDcsAllSessionsKill_base(name string) string {
	return fmt.Sprintf(`
...
func testAccDcsAllSessionsKill_basic(name string) string {
	return fmt.Sprintf(`
%s
...
`, testAccDcsAllSessionsKill_base(name))
}

...
func TestAccDcsClusterReplicaSwitch_basic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testDcsClusterReplicaSwitch_baic(name),
			},
		},
	})
}

func testDcsClusterReplicaSwitch_base(name string) string {
	return fmt.Sprintf(`
...
func testDcsClusterReplicaSwitch_baic(name string) string {
	return fmt.Sprintf(`
%s
...
`, testDcsClusterReplicaSwitch_base(name))
}

	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportStateIdFunc: testPgSchemaResourceImportState(rName),
			},
		},
	})
}
...
func testPgSchemaResourceImportState(name string) resource.ImportStateIdFunc {
	return func(s *terraform.State) (string, error) {
		...
		return fmt.Sprintf("%s/%s/%s", instanceID, dbName, schemaName), nil
	}
}

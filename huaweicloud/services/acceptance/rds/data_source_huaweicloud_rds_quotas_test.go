...
func TestAccDataSourceRdsQuotas_basic(t *testing.T) {
	dataSource := "data.huaweicloud_rds_quotas.test"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testDataSourceDataSourceRdsQuotas_basic(),
...
func testDataSourceDataSourceRdsQuotas_basic() string {
	return `

...
func TestAccDatasourceDmsRocketMQTopicGroup_basic(t *testing.T) {
	name := acceptance.RandomAccResourceName()
	resourceName := "data.huaweicloud_dms_rocketmq_topic_group.test"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDatasourceDmsRocketMQTopicGroup_basic(name),
...
func testAccDatasourceDmsRocketMQTopicGroup_basic(name string) string {
	return fmt.Sprintf(`

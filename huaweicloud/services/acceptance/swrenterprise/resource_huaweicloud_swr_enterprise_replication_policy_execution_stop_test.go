...
func TestAccSwrEnterpriseReplicationPolicyExecutionStop_basic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccSwrEnterpriseReplicationPolicyExecutionStop_basic(rName),
...
func testAccSwrEnterpriseReplicationPolicyExecutionStop_basic(rName string) string {
	return fmt.Sprintf(`
%s

...
func TestAccDataSourceEventStreams_basic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceEventStreamsConfig(),
...
func testAccDataSourceEventStreamsConfig() string {
	return `
data "huaweicloud_eg_event_streams" "test" {}

locals {
  stream_filter_result = data.huaweicloud_eg_event_streams.test.streams[0]
}

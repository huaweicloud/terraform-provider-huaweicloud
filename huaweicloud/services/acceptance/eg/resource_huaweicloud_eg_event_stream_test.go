		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(rName, "description", "Updated by acceptance test"),
					resource.TestCheckResourceAttr(rName, "status", "RUNNING"),
					resource.TestCheckResourceAttr(rName, "action", "START"),
					resource.TestCheckResourceAttrSet(rName, "created_at"),
					resource.TestCheckResourceAttrSet(rName, "updated_at"),
...
resource "huaweicloud_dms_kafka_instance" "test" {
  ...
  security_group_id = try(data.huaweicloud_networking_secgroups.test.security_groups[0].id, "")

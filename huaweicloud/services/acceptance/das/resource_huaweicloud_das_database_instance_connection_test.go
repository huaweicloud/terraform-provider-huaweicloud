	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportStateIdFunc:       testAccDatabaseInstanceConnectionImportStateFunc(resourceName),
			},
		},
	})
}
...
func testAccDatabaseInstanceConnectionImportStateFunc(resourceName string) resource.ImportStateIdFunc {
	return func(s *terraform.State) (string, error) {
		...
		if connectionId == "" {
			return "", fmt.Errorf("the resource's primary ID is not set for %s", resourceName)
		}

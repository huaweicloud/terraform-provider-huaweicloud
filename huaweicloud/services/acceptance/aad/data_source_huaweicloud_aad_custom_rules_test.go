...
func TestAccDataSourceCustomRules_basic(t *testing.T) {
	var (
		dataSource = "data.huaweicloud_aad_custom_rules.test"
	...
	resource.ParallelTest(t, resource.TestCase{
		PreCheck: func() {
			...
			// Please prepare an AAD domain name that has been configured with custom rules and configure it in the
		...
		Steps: []resource.TestStep{
			{
				Config: testDataSourceCustomRules_basic(),
...
func testDataSourceCustomRules_basic() string {
	return fmt.Sprintf(`

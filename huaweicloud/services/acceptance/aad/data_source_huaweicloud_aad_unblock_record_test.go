...
func TestAccAadUnblockRecordDataSource_basic(t *testing.T) {
	var (
		dataSourceName = "data.huaweicloud_aad_unblock_record.test"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAadUnblockRecord_basic(),
...
func testAadUnblockRecord_basic() string {

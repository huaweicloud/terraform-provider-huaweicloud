...
func TestAccDataAlarmNotifiedHistory_basic(t *testing.T) {
	resourceName := "data.huaweicloud_aom_alarm_notified_history.test"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataAlarmNotifiedHistory_basic(),
...
func testAccDataAlarmNotifiedHistory_basic() string {
	return fmt.Sprintf(`

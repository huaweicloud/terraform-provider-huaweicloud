...
func TestAccDataSourceVpcSubnetTags_basic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testDataSourceVpcSubnetTags_basic(randName),
...
func testDataSourceVpcSubnetTags_base(rName string) string {
	return fmt.Sprintf(`
...
func testDataSourceVpcSubnetTags_basic(rName string) string {
	return fmt.Sprintf(`
%s
...
`, testDataSourceVpcSubnetTags_base(rName))
}

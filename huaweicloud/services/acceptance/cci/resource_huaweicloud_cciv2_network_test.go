		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "annotations['yangtse.io/warm-pool-size']", "10"),
					resource.TestCheckResourceAttr(resourceName, "annotations['yangtse.io/warm-pool-recycle-interval']", "2"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					rc.CheckResourceExists(),
					resource.TestCheckResourceAttr(resourceName, "annotations['yangtse.io/warm-pool-size']", "8"),
					resource.TestCheckResourceAttr(resourceName, "annotations['yangtse.io/warm-pool-recycle-interval']", "3"),
					resource.TestCheckResourceAttrPair(resourceName, "security_group_ids.0",
...
resource "huaweicloud_cciv2_network" "test" {
  namesapce = huaweicloud_cciv2_namespace.test.name
  name      = %[3]s
...
`, common.TestBaseNetwork(rName), testAccCciNamespace_basic(rName), rName)
}

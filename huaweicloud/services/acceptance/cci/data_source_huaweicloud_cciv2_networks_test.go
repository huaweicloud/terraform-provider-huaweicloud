		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(dataSourceName, "networks.0.labels"),
					...
					resource.TestCheckResourceAttrSet(dataSourceName, "networks.0.self_link"),
					resource.TestCheckResourceAttrSet(dataSourceName, "networks.0.uid"),
					resource.TestCheckResourceAttrSet(dataSourceName, "networks.0.ip_families"),

...
func TestAccEcDatakeyPair_basic(t *testing.T) {
	rName := "huaweicloud_kms_ec_datakey_pair.test"
	// lintignore:AT001
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccEcDatakeyPair_basic(),
...
func testAccEcDatakeyPair_basic() string {
	return fmt.Sprintf(`

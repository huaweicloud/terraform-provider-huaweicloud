		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "redirect_url_config.0.host", "testhostupdate.com"),
					resource.TestCheckResourceAttr(resourceName, "redirect_url_config.0.port", "8888"),
					resource.TestCheckResourceAttr(resourceName, "redirect_url_config.0.path", "/test_policy_update"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "fixed_response_config.0.content_type", "application/json"),
					resource.TestCheckResourceAttr(resourceName, "fixed_response_config.0.message_body", "it is a test"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "fixed_response_config.0.content_type", "text/css"),
					resource.TestCheckResourceAttr(resourceName, "fixed_response_config.0.message_body", "it is a test update"),
				),
			},
			{
				ResourceName:      resourceName,

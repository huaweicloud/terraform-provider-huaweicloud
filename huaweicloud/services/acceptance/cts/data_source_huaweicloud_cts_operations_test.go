		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckOutput("is_filter_by_service_type_useful", "true"),
					resource.TestCheckOutput("is_filter_by_resource_type_useful", "true"),
				),
			},
		},
	})
...
output "is_filter_by_service_type_useful" {
...
output "is_filter_by_resource_type_useful" {

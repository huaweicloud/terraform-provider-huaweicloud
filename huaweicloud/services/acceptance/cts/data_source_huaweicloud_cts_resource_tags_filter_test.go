...
func TestAccDataSourceCtsResourceTagsFilter_basic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceCtsResourceTagsFilter_basic(),
...
func TestAccDataSourceCtsResourceTagsFilter_withTags(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceCtsResourceTagsFilter_withTags(),
				Check: resource.ComposeTestCheckFunc(
					dc.CheckResourceExists(),
					resource.TestCheckResourceAttrSet(dataSourceName, "resources.#"),
					resource.TestCheckOutput("is_resources_exist", "true"),
...
func testAccDataSourceCtsResourceTagsFilter_base() string {
	return `
...
func testAccDataSourceCtsResourceTagsFilter_basic() string {
	return fmt.Sprintf(`
%s
...
`, testAccDataSourceCtsResourceTagsFilter_base())
}

func testAccDataSourceCtsResourceTagsFilter_withTags() string {
	return `

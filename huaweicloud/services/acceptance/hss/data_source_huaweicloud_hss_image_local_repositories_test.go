...
func TestAccDataSourceImageLocalRepositories_basic(t *testing.T) {
	var (
		dataSourceName = "data.huaweicloud_hss_image_local_repositories.test"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testDataSourceImageLocalRepositories_basic(),
...
func testDataSourceImageLocalRepositories_basic() string {
	return `

...
sidebar_current: "docs-huaweicloud-datasource-s3-bucket-object"
description: |-
...
!> **Warning:** It has been deprecated, use `huaweicloud obs` instead.
...
```hcl
data "huaweicloud_s3_bucket_object" "b" {

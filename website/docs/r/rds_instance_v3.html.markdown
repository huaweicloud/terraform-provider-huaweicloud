---
layout: "huaweicloud"
page_title: "HuaweiCloud: huaweicloud_rds_instance_v3"
sidebar_current: "docs-huaweicloud-resource-rds-instance-v3"
description: |-
  instance management
---

# huaweicloud\_rds\_instance\_v3
...
```hcl
resource "huaweicloud_kms_key_v1" "key" {
  key_alias       = "key_1"
...
resource "huaweicloud_rds_instance_v3" "instance" {
  ...
  vpc_id = "{{ vpc_id }}"
  volume {
    disk_encryption_id = "${huaweicloud_kms_key_v1.key.id}"
    type = "ULTRAHIGH"
    size = 100
  }
  flavor = "rds.pg.c2.medium"
...
```
$ terraform import huaweicloud_rds_instance_v3.instance_1 7117d38e-4c8f-4624-a505-bd96b97d024c
```

But due to some attrubutes missing from the API response, it's required to ignore changes as below.

```
resource "huaweicloud_rds_instance_v3" "instance_1" {
  ...

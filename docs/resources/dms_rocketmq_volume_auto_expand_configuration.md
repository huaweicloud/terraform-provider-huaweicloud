...
layout: "huaweicloud"
page_title: "HuaweiCloud: huaweicloud_dms_rocketmq_volume_auto_expand_configuration"
description: |-
  Use this resource to configure the volume auto-expansion for the specified RocketMQ instance within HuaweiCloud.
---

# huaweicloud_dms_rocketmq_volume_auto_expand_configuration
...
* `region` - (Optional, String, ForceNew) Specifies the region where the instance to be configured volume

...
-> The current resource is a one-time resource, and destroying this resource will not recover the volume type,
but will only remove the resource information from the tfstate file. All resource related to this retyped volume will
be affected, and volume_type will be updated.

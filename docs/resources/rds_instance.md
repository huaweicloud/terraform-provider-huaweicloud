...
* `enterprise_project_id` - (Optional) The enterprise project id of the RDS instance. Changing this creates a new RDS instance.
...
* `version` - (Required) Specifies the database version. Changing this parameter will create a new resource.

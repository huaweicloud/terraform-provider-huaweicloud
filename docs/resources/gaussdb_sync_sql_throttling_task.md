...
subcategory: "GaussDB"
layout: "huaweicloud"
page_title: "HuaweiCloud: huaweicloud_gaussdb_sync_sql_throttling_task"
description: |-
  Manages a GaussDB OpenGauss sync SQL throttling task resource within HuaweiCloud.
---

# huaweicloud_gaussdb_sync_sql_throttling_task
...
resource "huaweicloud_gaussdb_sync_sql_throttling_task" "test" {

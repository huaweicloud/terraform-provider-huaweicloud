...
layout: "huaweicloud"
page_title: "HuaweiCloud: huaweicloud_taurusdb_quota"
description: |-
  Manages a TaurusDB quota resource within HuaweiCloud.
---

# huaweicloud_taurusdb_quota
...
resource "huaweicloud_taurusdb_quota" "test" {
...
The TaurusDB quota can be imported using the `id`, e.g.

```bash
$ terraform import huaweicloud_taurusdb_quota.test <id>
```

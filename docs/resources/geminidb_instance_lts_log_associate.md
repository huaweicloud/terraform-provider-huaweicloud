...
layout: "huaweicloud"
page_title: "HuaweiCloud: huaweicloud_geminidb_instance_lts_log_associate"
description: |-
  Manages a GeminiDB instance LTS log associate resource within HuaweiCloud.
---
...
* `instance_id` - (Required, String, NonUpdatable) Specifies the instance ID of the GeminiDB instance.  
...
The GeminiDB instance LTS log associate resource can be imported using `instance_id` and `log_type` separated by a
slash (`/`), e.g.

...
layout: "huaweicloud"
page_title: "HuaweiCloud: huaweicloud_taurusdb_lts_log"
description: |-
  Manages a TaurusDB LTS log resource within HuaweiCloud.
---

# huaweicloud_taurusdb_lts_log
...
The TaurusDB LTS log can be imported using `instance_id` and `log_type` separated by a slash, e.g.

```bash
$ terraform import huaweicloud_taurusdb_lts_log.test <instance_id>/<log_type>
```

...
-> 1. If the modified parameters require restarting the DWS cluster, the modified values ​​will be displayed in the
   ...
   <br>2. This resource is only used to modify the DWS cluster parameter configurations. Deleting this resource will

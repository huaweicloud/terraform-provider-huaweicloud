...
# huaweicloud_vpc_route_table_route
...
resource "huaweicloud_vpc_route_table_route" "vpc_route" {
  vpc_id      = var.vpc_id
...
```
$ terraform import huaweicloud_vpc_route_table_route.test <route_table_id>/<destination>
```

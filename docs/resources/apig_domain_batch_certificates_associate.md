...
layout: "huaweicloud"
page_title: "HuaweiCloud: huaweicloud_apig_domain_batch_certificates_associate"
description: |-
  Use this resource to associate SSL certificates to the specified domain within HuaweiCloud.
---

# huaweicloud_apig_domain_batch_certificates_associate
...
```shell
$ terraform import huaweicloud_apig_domain_batch_certificates_associate.test <instance_id>/<group_id>/<domain_id>
```

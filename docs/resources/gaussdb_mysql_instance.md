...
* `tags` - (Optional, Map) A mapping of tags to assign to the GaussDB mysql instance.
...
* `engine` - (Required, String, ForceNew) Specifies the database engine. Only "gauss-mysql" is supported now.

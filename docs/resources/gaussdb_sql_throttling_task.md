...
subcategory: "GaussDB"
layout: "huaweicloud"
page_title: "HuaweiCloud: huaweicloud_gaussdb_sql_throttling_task"
description: |-
  Manages a GaussDB OpenGauss SQL throttling task resource within HuaweiCloud.
---

# huaweicloud_gaussdb_sql_throttling_task
...
resource "huaweicloud_gaussdb_sql_throttling_task" "source" {

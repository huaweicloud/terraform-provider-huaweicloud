...
subcategory: "GaussDB"
layout: "huaweicloud"
page_title: "HuaweiCloud: huaweicloud_gaussdb_parameter_template_compare"
description: |-
  Manages a GaussDB OpenGauss parameter template compare resource within HuaweiCloud.
---

# huaweicloud_gaussdb_parameter_template_compare
...
resource "huaweicloud_gaussdb_parameter_template_compare" "test" {

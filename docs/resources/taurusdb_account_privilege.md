...
layout: "huaweicloud"
page_title: "HuaweiCloud: huaweicloud_taurusdb_account_privilege"
description: ""
---

# huaweicloud_taurusdb_account_privilege

Manages a TaurusDB account privilege resource within HuaweiCloud.
...
The TaurusDB account privilege can be imported using the `instance_id`, `name` and `host` separated by slashes, e.g.

```bash
$ terraform import huaweicloud_taurusdb_account_privilege.test <instance_id>/<account_name>/<host>
```

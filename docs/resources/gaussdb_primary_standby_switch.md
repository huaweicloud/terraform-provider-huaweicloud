...
subcategory: "GaussDB"
layout: "huaweicloud"
page_title: "HuaweiCloud: huaweicloud_gaussdb_primary_standby_switch"
description: |-
  Manages a GaussDB OpenGauss primary standby switch resource within HuaweiCloud.
---

# huaweicloud_gaussdb_primary_standby_switch
...
resource "huaweicloud_gaussdb_primary_standby_switch" "test" {

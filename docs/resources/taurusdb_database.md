...
layout: "huaweicloud"
page_title: "HuaweiCloud: huaweicloud_taurusdb_database"
description: ""
---

# huaweicloud_taurusdb_database

Manages a TaurusDB database resource within HuaweiCloud.
...
The TaurusDB database can be imported using the `instance_id` and `name` separated by a slash, e.g.

```bash
$ terraform import huaweicloud_taurusdb_database.test <instance_id>/<name>
```

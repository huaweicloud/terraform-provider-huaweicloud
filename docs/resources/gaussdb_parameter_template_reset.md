...
subcategory: "GaussDB"
layout: "huaweicloud"
page_title: "HuaweiCloud: huaweicloud_gaussdb_parameter_template_reset"
description: |-
  Manages a GaussDB OpenGauss parameter template reset resource within HuaweiCloud.
---

# huaweicloud_gaussdb_parameter_template_reset
...
resource "huaweicloud_gaussdb_parameter_template_reset" "test" {

...
layout: "huaweicloud"
page_title: "HuaweiCloud: huaweicloud_taurusdb_backup"
description: ""
---

# huaweicloud_taurusdb_backup

Manages a TaurusDB backup resource within HuaweiCloud.
...
```bash
$ terraform import huaweicloud_taurusdb_backup.test <id>
```

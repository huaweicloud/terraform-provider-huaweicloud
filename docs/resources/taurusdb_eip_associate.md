...
layout: "huaweicloud"
page_title: "HuaweiCloud: huaweicloud_taurusdb_eip_associate"
description: |-
  Manages GaussDB mysql EIP associate resource within HuaweiCloud.
---

# huaweicloud_taurusdb_eip_associate
...
* `instance_id` - (Required, String, ForceNew) Specifies the ID of a TaurusDB instance. Changing this parameter
...
The TaurusDB EIP associate can be imported using `id`, e.g.

```bash
$ terraform import huaweicloud_taurusdb_eip_associate.test <id>
```

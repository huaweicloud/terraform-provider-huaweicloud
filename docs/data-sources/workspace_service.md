...
* `lock_time` - The time of the service is locked.

* `lock_reason` - The reason of the service is locked.
...
* `rule_type` - The authentication application object type.

* `rule` - The authentication application object.

...
layout: "huaweicloud"
page_title: "HuaweiCloud: huaweicloud_taurusdb_flavors"
description: ""
---

# huaweicloud_taurusdb_flavors

Use this data source to get available HuaweiCloud TaurusDB flavors.

## Example Usage

```hcl
data "huaweicloud_taurusdb_flavors" "flavors" {
}
```
...
* `name` - The name of the TaurusDB flavor.

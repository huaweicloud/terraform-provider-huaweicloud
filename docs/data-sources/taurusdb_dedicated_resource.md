...
layout: "huaweicloud"
page_title: "HuaweiCloud: huaweicloud_taurusdb_dedicated_resource"
description: ""
---

# huaweicloud_taurusdb_dedicated_resource

Use this data source to get available HuaweiCloud TaurusDB dedicated resource.

## Example Usage

```hcl
data "huaweicloud_taurusdb_dedicated_resource" "this" {
  resource_name = "test"
}
```

...
* `user_details` - The list of database account details.
  The [user_details](#htap_starrocks_users_user_details_attr) structure is documented below.

<a name="htap_starrocks_users_user_details_attr"></a>
The `user_details` block supports:

* `user_name` - The database account name.

* `data_bases` - The list of authorized databases.

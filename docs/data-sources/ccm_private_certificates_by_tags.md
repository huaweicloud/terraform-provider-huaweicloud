...
layout: "huaweicloud"
page_title: "HuaweiCloud: huaweicloud_ccm_private_certificates_by_tags"
description: |-
  Use this data source to get a list of CCM private certificates by tags.
---

# huaweicloud_ccm_private_certificates_by_tags
...
* `resources` - The certificate details.
...
* `resource_id` - The ID of the private certificate.

* `tags` - The tags of the private certificate.
  The [tags](#tags_response_struct) structure is documented below.

* `resource_name` - The name of the private certificate.

* `resource_detail` - The details of the private certificate in JSON string format.

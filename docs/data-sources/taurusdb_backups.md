...
layout: "huaweicloud"
page_title: "HuaweiCloud: huaweicloud_taurusdb_backups"
description: |-
  Use this data source to get the list of TaurusDB backups.
---

# huaweicloud_taurusdb_backups
...
* `instance_id` - (Optional, String) Specifies the ID of the TaurusDB instance.
...
* `instance_name` - Indicates the name of the TaurusDB instance.

* `instance_id` - Indicates the ID of the TaurusDB instance.

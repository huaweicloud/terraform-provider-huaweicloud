...
description: |-
  Use this data source to get the alarm list with HuaweiCloud.
---
...
* `type` - (Required, String) Specifies the type of the alarm to be qurieied.  
...
* `time_range` - (Optional, String) Specifies the time range of the alarm to be quried, in minutes.  
...
* `step` - (Optional, Int) Specifies the step of the alarm, in milliseconds.

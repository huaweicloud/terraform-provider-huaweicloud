...
layout: "huaweicloud"
page_title: "HuaweiCloud: huaweicloud_geminidb_influxdb_slow_logs"
description: |-
  Use this data source to query the list of GeminiDB InfluxDB instance slow logs.
---

# huaweicloud_geminidb_influxdb_slow_logs
...
* `keywords` - (Optional, String) Specifies query the slow logs by keywords matched.
...
* `retention_policy` - (Optional, String) Specifies the retention policy.

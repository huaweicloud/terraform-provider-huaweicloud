...
layout: "huaweicloud"
page_title: "HuaweiCloud: huaweicloud_taurusdb_audit_log_download_links"
description: |-
  Use this data source to get the temporary link for downloading full SQL.
---

# huaweicloud_taurusdb_audit_log_download_links
...
* `node_id` - (Optional, String) Specifies the ID of the TaurusDB instance node.

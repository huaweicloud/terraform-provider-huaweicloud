...
layout: "huaweicloud"
page_title: "HuaweiCloud: huaweicloud_taurusdb_htap_starrocks_replication_config"
description: |-
  Use this data source to query configurations of a StarRocks data synchronization task within HuaweiCloud.
---

# huaweicloud_taurusdb_htap_starrocks_replication_config
...
* `task_name` - (Required, String) Specifies the name of the data synchronization task.

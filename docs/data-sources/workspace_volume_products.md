...
description: |-
  Use this data source to get the list of Workspace volume products.
---
...
data "huaweicloud_workspace_volume_products" "test" {
  availability_zone = try(data.huaweicloud_availability_zones.test.names[0], "NONE")
}
```
...
* `volume_products` - The list of volume products.  

...
* `tasks` - The list of synchronization tasks.
  The [tasks](#oms_migration_sync_tasks_struct) structure is documented below.

<a name="oms_migration_sync_tasks_struct"></a>
...
* `source_cdn` - Whether migration from CDN is enabled.
  The [source_cdn](#oms_migration_sync_tasks_source_cdn_struct) structure is documented below.
...
<a name="oms_migration_sync_tasks_source_cdn_struct"></a>

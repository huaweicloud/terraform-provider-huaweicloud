...
* `member_groups` - The list of the member groups that matched filter parameters.  
  The [member_groups](#apig_member_groups) structure is documented below.

<a name="apig_member_groups"></a>
...
* `microservice_labels` - The microservice labels of the member group.  
  The [microservice_labels](#apig_member_groups_microservice_labels) structure is documented below.
...
<a name="apig_member_groups_microservice_labels"></a>

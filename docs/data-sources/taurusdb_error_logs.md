...
layout: "huaweicloud"
page_title: "HuaweiCloud: huaweicloud_taurusdb_error_logs"
description: |-
  Use this data source to get the list of TaurusDB error logs.
---

# huaweicloud_taurusdb_error_logs
...
* `node_id` - (Required, String) Specifies the ID of the TaurusDB instance node
...
* `node_id` - Indicates the ID of the TaurusDB instance node

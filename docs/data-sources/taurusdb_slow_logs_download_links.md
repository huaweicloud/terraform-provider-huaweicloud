...
layout: "huaweicloud"
page_title: "HuaweiCloud: huaweicloud_taurusdb_slow_logs_download_links"
description: |-
  Use this data source to query the download links of slow logs of TaurusDB instance within HuaweiCloud.
---

# huaweicloud_taurusdb_slow_logs_download_links
...
* `list` - Indicates the list of the slow log download links.
...
* `status` - Indicates the download status.

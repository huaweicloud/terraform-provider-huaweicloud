...
* `device_group_id` - (Optional, String) Specifies the ID of the device group.

* `name` - (Optional, String) Specifies the name of the device group.

* `group_type` - (Optional, String) Specifies the type of the device group.
...
* `space_id` - (Optional, String) Specifies the ID of the resource space to which the device group belongs.
...
* `device_groups` - The list of the device groups.
  The [device_groups](#iotda_device_groups) structure is documented below.
...
* `group_type` - The type of the device group.

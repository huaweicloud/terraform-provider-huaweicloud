---
subcategory: "Cloud Container Engine"
layout: "huaweicloud"
page_title: "HuaweiCloud: huaweicloud_cce_release_history"
description: |-
  Use this data source to get the list of historical records of a CCE chart release within HuaweiCloud.
---

# huaweicloud_cce_release_history
...
* `name` - (Required, String) Specifies the name of the chart release.

* `namespace` - (Required, String) Specifies the namespace to which the chart release belongs.

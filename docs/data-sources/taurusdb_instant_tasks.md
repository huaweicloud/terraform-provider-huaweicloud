...
layout: "huaweicloud"
page_title: "HuaweiCloud: huaweicloud_taurusdb_instant_tasks"
description: |-
  Use this data source to get the list of TaurusDB instant tasks.
---

# huaweicloud_taurusdb_instant_tasks
...
```hcl
data "huaweicloud_taurusdb_instant_tasks" "test" {}
```

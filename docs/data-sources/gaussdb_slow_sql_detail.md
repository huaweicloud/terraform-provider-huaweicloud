...
subcategory: "GaussDB"
layout: "huaweicloud"
page_title: "HuaweiCloud: huaweicloud_gaussdb_slow_sql_detail"
description: |-
  Use this data source to query the slow SQL detail of GaussDB instances within HuaweiCloud.
---

# huaweicloud_gaussdb_slow_sql_detail
...
* `region` - (Optional, String) Specifies the region in which to query the slow SQL detail.
...
* `multi_queries` - (Optional, List) Specifies the list of multi-query conditions.
  The [multi_queries](#gaussdb_slow_sql_detail_multi_queries) structure is documented below.

<a name="gaussdb_slow_sql_detail_multi_queries"></a>
...
* `slow_sql_details` - The list of slow SQL details.
  The [slow_sql_details](#gaussdb_slow_sql_detail_slow_sql_details) structure is documented below.

<a name="gaussdb_slow_sql_detail_slow_sql_details"></a>

...
* `type` - (Optional, String) Specifies the bigdata asset type. Valid values are **Elasticsearch**, **DLI**, **Hive**, **HBase**, **MRS_HIVE**, **ALL**, **LTS**, **HIVE_ONLY** and **JUST_BIG_DATA**.
...
* `total` - The total number of bigdata assets.

...
layout: "huaweicloud"
page_title: "HuaweiCloud: huaweicloud_taurusdb_pt_applicable_instances"
description: |-
  Use this data source to get the TaurusDB instances that a parameter template can be applied to.
---

# huaweicloud_taurusdb_pt_applicable_instances

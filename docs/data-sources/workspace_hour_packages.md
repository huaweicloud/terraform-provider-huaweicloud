...
description: |-
  Use this data source to get the list of Workspace hour packages.
---
...
* `desktop_resource_spec_code` - (Optional, String) Specifies the ID of desktop resource to be queried.

* `resource_spec_code` - (Optional, String) Specifies the ID of hour package to be queried.
...
* `hour_packages` - The list of hour package information.  
  The [hour_packages](#workspace_hour_packages_attr) structure is documented below.

<a name="workspace_hour_packages_attr"></a>
...
* `descriptions` - The descriptions of hour package.  
  The [descriptions](#workspace_hour_package_descriptions) structure is documented below.
...
<a name="workspace_hour_package_descriptions"></a>

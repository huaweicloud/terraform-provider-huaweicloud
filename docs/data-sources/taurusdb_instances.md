...
layout: "huaweicloud"
page_title: "HuaweiCloud: huaweicloud_taurusdb_instances"
description: ""
---

# huaweicloud_taurusdb_instances

Use this data source to list all available HuaweiCloud TaurusDB instances.

## Example Usage

```hcl
data "huaweicloud_taurusdb_instances" "this" {

...
layout: "huaweicloud"
page_title: "HuaweiCloud: huaweicloud_taurusdb_proxy_flavors"
description: |-
  Use this data source to get the list of TaurusDB proxy flavors.
---

# huaweicloud_taurusdb_proxy_flavors
...
* `instance_id` - (Required, String) Specifies the ID of TaurusDB Instance.

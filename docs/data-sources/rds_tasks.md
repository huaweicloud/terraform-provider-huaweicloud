...
* `task_detailed` - Indicates the displayed information varies depending on the tasks.

* `fail_reason` - Indicates the error information displayed when a task failed.

* `entitites` - Indicates the displayed information varies depending on the tasks.

The 'instance' block within 'jobs' supports:

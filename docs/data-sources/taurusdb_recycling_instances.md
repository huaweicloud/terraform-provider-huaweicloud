...
layout: "huaweicloud"
page_title: "HuaweiCloud: huaweicloud_taurusdb_recycling_instances"
description: |-
  Use this data source to get the list of instances in the recycle bin.
---

# huaweicloud_taurusdb_recycling_instances
...
```hcl
data "huaweicloud_taurusdb_recycling_instances" "test" {}
```

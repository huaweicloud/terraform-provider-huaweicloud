...
layout: "huaweicloud"
page_title: "HuaweiCloud: huaweicloud_rgc_config_rule_compliances"
description: |-
 Use this data source get config rule compliance status in Resource Governance Center.
---

# huaweicloud_rgc_config_rule_compliances
...
* `config_rule_compliances` - Information about the config rule compliance.

...
layout: "huaweicloud"
page_title: "HuaweiCloud: huaweicloud_taurusdb_instance"
description: ""
---

# huaweicloud_taurusdb_instance

Use this data source to get available HuaweiCloud TaurusDB instance.

## Example Usage

```hcl
data "huaweicloud_taurusdb_instance" "this" {

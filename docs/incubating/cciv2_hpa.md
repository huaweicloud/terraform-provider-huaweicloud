...
* `metric` - (Required, List) Specifies the metric of external metric source.
  The [metric](#common_metric) structure is documented below.

* `target` - (Required, List) Specifies the target of external metric source.
  The [target](#common_target) structure is documented below.
...
* `metric` - (Required, List) Specifies the container resource metric source.
  The [metric](#common_metric) structure is documented below.

* `target` - (Required, List) Specifies the container resource metric source.
  The [target](#common_target) structure is documented below.
...
* `target` - (Required, List) Specifies the container resource pod metric source.
  The [target](#common_target) structure is documented below.

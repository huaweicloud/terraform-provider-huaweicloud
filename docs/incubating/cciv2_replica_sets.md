...
* `env` - <!-- please add the description of the attribute -->
  The [env](#spec_termination_grace_period_seconds--env) structure is documented below.

* `image` - <!-- please add the description of the attribute -->

* `name` - <!-- please add the description of the attribute -->

* `resources` - <!-- please add the description of the attribute -->
  The [resources](#spec_termination_grace_period_seconds--resources) structure is documented below.

<a name="spec_termination_grace_period_seconds--env"></a>
The `env` block supports:

* `name` - <!-- please add the description of the attribute -->

* `value` - <!-- please add the description of the attribute -->

<a name="spec_termination_grace_period_seconds--resources"></a>
The `resources` block supports:

* `limits` - <!-- please add the description of the attribute -->

* `requests` - <!-- please add the description of the attribute -->

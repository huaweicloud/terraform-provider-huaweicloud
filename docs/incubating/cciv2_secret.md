...
* `name` - (Required, String) The name of the CCI Secret.

* `namespace` - (Required, String) Specifies the namespace.

* `binary_data` - (Optional, Map) Specifies The binary data of the CCI Secret.
...
* `immutable` - Specifies the immutable of the CCI Secret.

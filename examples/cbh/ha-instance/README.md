...
- **How we can configure the availability zones of the CBH HA instance?**

    If your business requires high performance (e.g., low network latency),  
    deploy primary and standby availability zones in the same region. This  
    ensures fast and stable network connections.

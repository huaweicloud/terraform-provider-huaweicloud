# Create a readonly node for DDS replicaset instance

This example provides best practice code for using Terraform to create a readonly node for DDS replicaset instance
in HuaweiCloud.
...
* `node_spec` - The spec code of the read only node (default: "dds.mongodb.s6.large.4.rr")
...
* The creation of the DDS readonly node takes about 20 to 60 minutes

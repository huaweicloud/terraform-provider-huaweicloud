...
This example provides best practice code for using Terraform to create a DDS backup in HuaweiCloud.
...
* `region_name` - The region where the DDS backup is located
...
* `backup_name` - The name of the DDS backup
...
* `backup_description` - The description of the DDS backup (default: "")

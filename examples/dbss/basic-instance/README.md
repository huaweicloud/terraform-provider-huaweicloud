# Create a DBSS instance

This example provides best practice code for using Terraform to create a DBSS instance in HuaweiCloud.
...
* `instance_flavor_id` - The flavor ID of the DBSS instance (default: "")

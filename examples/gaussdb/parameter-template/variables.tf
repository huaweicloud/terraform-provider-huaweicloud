...
# Variable definitions for base network resources
variable "vpc_name" {
...
variable "instance_availability_zones" {
  description = "The availability zones of the GaussDB instance, separated by commas"
  type        = string
  nullable    = false
  default     = ""
}
...
variable "instance_flavor" {
  description = "The flavor spec code of the GaussDB instance"
  type        = string
  nullable    = false
...
variable "instance_password" {
  description = "The password of the GaussDB instance"
  type        = string
  sensitive   = true
  nullable    = false
  default     = ""
...
variable "instance_volume_type" {
  description = "The volume type of the GaussDB instance"
  type        = string
  nullable    = false
  default     = "ULTRAHIGH"
}
...
variable "instance_volume_size" {
  description = "The volume size (GB) of the GaussDB instance"
  type        = string
  nullable    = false
  default     = "40"
}
...
variable "engine_version" {
  description = "The engine version of the parameter template"
  type        = string
  nullable    = false
  default     = "8.218"
}
...
variable "instance_mode" {
  description = "The instance mode of the parameter template"
  type        = string
  nullable    = false
  default     = "ha"
}
...
variable "template_parameters" {
  description = "The parameters of the parameter template, each item contains name and value"
  type        = list(object({
    name  = string
    value = string
  }))

...
This example provides best practice code for using Terraform to create a GES (Graph Engine Service) graph instance
in HuaweiCloud, including the required VPC, subnet, and security group.
...
* `region_name` - The region where the GES graph is located
...
* The creation of the GES graph takes about 30 minutes
* The VPC, subnet, and security group must be in the same region as the GES graph
* The `graph_size_type_index` can be updated to resize the graph instance

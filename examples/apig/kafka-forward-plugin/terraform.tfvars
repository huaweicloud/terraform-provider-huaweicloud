...
# kafka_sasl_username   = ""           # Leave empty to use kafka_access_user
# kafka_sasl_password   = ""           # Leave empty to use kafka_password
# kafka_ssl_ca_content  = ""           # SSL CA certificate content for SSL/TLS connections

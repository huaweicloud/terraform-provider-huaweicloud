...
data "huaweicloud_dms_kafka_flavors" "test" {
  count = var.kafka_instance_flavor_id == "" ? 1 : 0
...
resource "huaweicloud_dms_kafka_instance" "test" {
  ...
  flavor_id          = var.kafka_instance_flavor_id == "" ? try(data.huaweicloud_dms_kafka_flavors.test[0].flavors[0].id, null) : var.kafka_instance_flavor_id

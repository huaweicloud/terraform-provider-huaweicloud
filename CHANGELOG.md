...
* **New Resource Source:**
  + `huaweicloud_dataarts_architecture_dimension` [GH-10179]
  + `huaweicloud_dsc_asset_domain_label` [GH-10209]
  + `huaweicloud_dsc_batch_delete_database_instance` [GH-10209]
  + `huaweicloud_dsc_batch_delete_obs` [GH-10209]
  + `huaweicloud_dsc_bigdata_instance` [GH-10201]
  + `huaweicloud_dsc_data_map_score_update` [GH-10209]
  + `huaweicloud_dsc_device` [GH-10178]
  + `huaweicloud_dsc_multi_enable_trusted_service` [GH-10209]
  + `huaweicloud_dsc_stop_scan_job` [GH-10209]
  + `huaweicloud_dsc_switch_job` [GH-10209]
  + `huaweicloud_dsc_update_security_levels_sort` [GH-10204]
  + `huaweicloud_gaussdb_download_backups_authorize` [GH-10206]
  + `huaweicloud_gaussdb_idle_sessions_query_and_kill` [GH-10176]
  + `huaweicloud_gaussdb_instance_account_permission` [GH-10005]
  + `huaweicloud_gaussdb_instance_role_permission` [GH-10040]
  + `huaweicloud_gaussdb_redistribution_parameters_modify` [GH-10135]
  + `huaweicloud_gaussdb_specified_sessions_query_and_kill` [GH-10161]
  + `huaweicloud_identityv5_policy_agency_attach` [GH-10072]
  + `huaweicloud_lts_elb_log` [GH-10210]
  + `huaweicloud_secmaster_classifier` [GH-10070]
  + `huaweicloud_secmaster_data_class_type_layout` [GH-10074]
  + `huaweicloud_taurusdb_htap_starrocks_instance` [GH-9789]
  + `huaweicloud_taurusdb_htap_starrocks_parameters_compare` [GH-10191]
  + `huaweicloud_taurusdb_instance_database_batch_upgrade` [GH-10128]
  + `huaweicloud_taurusdb_proxy_eip_associate` [GH-10121]
  + `huaweicloud_taurusdb_proxy_upgrade` [GH-10142]

* **New Data Source:**
  + `huaweicloud_cce_node_pools` [GH-10196]
  + `huaweicloud_dataarts_architecture_dimensions` [GH-10179]
  + `huaweicloud_dsc_alarm_handling_trend` [GH-10178]
  + `huaweicloud_dsc_alarms` [GH-10178]
  + `huaweicloud_dsc_asset_overview` [GH-10178]
  + `huaweicloud_dsc_asset_quota` [GH-10178]
  + `huaweicloud_dsc_assets_count` [GH-10178]
  + `huaweicloud_dsc_authorize_databases` [GH-10200]
  + `huaweicloud_dsc_bigdata_instance_databases` [GH-10201]
  + `huaweicloud_dsc_catalog_details_by_obs` [GH-10178]
  + `huaweicloud_dsc_catalog_instances` [GH-10192]
  + `huaweicloud_dsc_catalog_quantity_variation` [GH-10178]
  + `huaweicloud_dsc_catalog_statical_chart` [GH-10178]
  + `huaweicloud_dsc_catalog_statistics` [GH-10178]
  + `huaweicloud_dsc_catalog_top_classifications` [GH-10198]
  + `huaweicloud_dsc_column_details_by_classification` [GH-10178]
  + `huaweicloud_dsc_column_details_by_database` [GH-10178]
  + `huaweicloud_dsc_dashboard_score` [GH-10178]
  + `huaweicloud_dsc_data_map_dynamic_data_infos` [GH-10178]
  + `huaweicloud_dsc_data_map_score` [GH-10178]
  + `huaweicloud_dsc_data_map_security_level` [GH-10178]
  + `huaweicloud_dsc_database_instances` [GH-10178]
  + `huaweicloud_dsc_dbss_ins_info` [GH-10214]
  + `huaweicloud_dsc_dbss_oem_info` [GH-10178]
  + `huaweicloud_dsc_device_monitor_infos` [GH-10178]
  + `huaweicloud_dsc_devices` [GH-10178]
  + `huaweicloud_dsc_event_overview` [GH-10178]
  + `huaweicloud_dsc_events` [GH-10178]
  + `huaweicloud_dsc_export_buckets` [GH-10211]
  + `huaweicloud_dsc_features` [GH-10178]
  + `huaweicloud_dsc_multi_account_assets` [GH-10178]
  + `huaweicloud_dsc_multi_account_info` [GH-10178]
  + `huaweicloud_dsc_multi_accounts` [GH-10178]
  + `huaweicloud_dsc_multi_organization_tree` [GH-10178]
  + `huaweicloud_dsc_multi_organizations` [GH-10178]
  + `huaweicloud_dsc_protect_data_types` [GH-10178]
  + `huaweicloud_dsc_protect_measure_baseline` [GH-10178]
  + `huaweicloud_dsc_scan_jobs` [GH-10178]
  + `huaweicloud_dsc_scan_rules` [GH-10178]
  + `huaweicloud_dsc_scan_security_levels` [GH-10188]
  + `huaweicloud_dsc_scan_tasks` [GH-10178]
  + `huaweicloud_dsc_security_class` [GH-10178]
  + `huaweicloud_dsc_show_metadata` [GH-10178]
  + `huaweicloud_dsc_show_tasks` [GH-10187]
  + `huaweicloud_dsc_supported_column_types` [GH-10194]
  + `huaweicloud_dsc_template_rules` [GH-10178]
  + `huaweicloud_dsc_threat_trend` [GH-10178]
  + `huaweicloud_dsc_user_list` [GH-10178]
  + `huaweicloud_dsc_vpc_ep_quotas` [GH-10178]
  + `huaweicloud_gaussdb_backup_configurations` [GH-10076]
  + `huaweicloud_gaussdb_datastore_instances` [GH-10085]
  + `huaweicloud_gaussdb_datastore_versions` [GH-10116]
  + `huaweicloud_gaussdb_full_sql_statistics` [GH-10168]
  + `huaweicloud_gaussdb_instance_auto_enlarge_policy` [GH-10053]
  + `huaweicloud_gaussdb_instance_real_time_sessions` [GH-10069]
  + `huaweicloud_gaussdb_key_view_nodes_deliver` [GH-10060]
  + `huaweicloud_gaussdb_kms_keys` [GH-10186]
  + `huaweicloud_gaussdb_parameter_setting_template` [GH-10120]
  + `huaweicloud_gaussdb_real_time_transactions` [GH-10205]
  + `huaweicloud_gaussdb_rts_overview` [GH-10153]
  + `huaweicloud_gaussdb_rts_statistics` [GH-10153]
  + `huaweicloud_gaussdb_rts_top_sql_statistics` [GH-10144]
  + `huaweicloud_gaussdb_rts_waiting_event_statistics` [GH-10132]
  + `huaweicloud_gaussdb_session_memory_contexts` [GH-10153]
  + `huaweicloud_gaussdb_shard_storage` [GH-10184]
  + `huaweicloud_gaussdb_single_full_sqls` [GH-10103]
  + `huaweicloud_gaussdb_single_sql_details` [GH-10141]
  + `huaweicloud_gaussdb_sql_execution_plan` [GH-10197]
  + `huaweicloud_gaussdb_sql_explorer_status_records` [GH-10041]
  + `huaweicloud_gaussdb_sql_stack_information` [GH-10190]
  + `huaweicloud_gaussdb_sql_traces` [GH-10155]
  + `huaweicloud_geminidb_cassandra_slow_logs` [GH-10056]
  + `huaweicloud_geminidb_instance_databases` [GH-10052]
  + `huaweicloud_geminidb_jobs` [GH-10061]
  + `huaweicloud_modelarts_devserver_images` [GH-10067]
  + `huaweicloud_modelarts_devserver_job_templates` [GH-10067]
  + `huaweicloud_secmaster_component_alliances` [GH-10077]
  + `huaweicloud_secmaster_configuration_functions` [GH-10068]
  + `huaweicloud_secmaster_dataclass_types` [GH-10086]
  + `huaweicloud_secmaster_subscription_orders` [GH-10051]
  + `huaweicloud_secmaster_workbenches` [GH-10081]
  + `huaweicloud_taurusdb_audit_logs_download_links` [GH-10059]
  + `huaweicloud_taurusdb_audit_logs` [GH-10059]
  + `huaweicloud_taurusdb_dedicated_resource_details` [GH-10163]
  + `huaweicloud_taurusdb_error_logs_download_links` [GH-10049]
  + `huaweicloud_taurusdb_instance_db_table_info` [GH-10087]
  + `huaweicloud_taurusdb_proxy_az_flavors` [GH-10108]
  + `huaweicloud_taurusdb_slow_logs_download_links` [GH-10055]
  + `huaweicloud_taurusdb_slow_logs_statistics` [GH-10071]

## 1.94.0 (June 30, 2026)

* **New Resource Source:**
  + `huaweicloud_das_slow_log_export_task` [GH-9909]
  + `huaweicloud_dli_sql_job_result_export` [GH-9921]
  + `huaweicloud_dms_kafka_recycle_instance_restore` [GH-9933]
  + `huaweicloud_dms_rocketmq_recycle_instance_restore` [GH-9948]
  + `huaweicloud_gaussdb_client_auth_config_restore` [GH-9977]
  + `huaweicloud_gaussdb_dr_instance_primary_role_switch` [GH-9977]
  + `huaweicloud_gaussdb_dr_relationship_reestablish` [GH-9977]
  + `huaweicloud_gaussdb_instance_database_account` [GH-9998]
  + `huaweicloud_gaussdb_instance_database_role` [GH-10017]
  + `huaweicloud_gaussdb_instance_full_sqls_config` [GH-10018]
  + `huaweicloud_gaussdb_instance_lts_log_associate` [GH-9977]
  + `huaweicloud_gaussdb_instance_plugin_extensions_config` [GH-9977]
  + `huaweicloud_gaussdb_instance_plugin` [GH-9860]
  + `huaweicloud_geminidb_high_risk_command` [GH-9958]
  + `huaweicloud_geminidb_instance_lts_log_associate` [GH-9981]
  + `huaweicloud_geminidb_sessions_close` [GH-9936]
  + `huaweicloud_secmaster_checkitem` [GH-10028]
  + `huaweicloud_secmaster_collector_parser` [GH-9856]
  + `huaweicloud_secmaster_configuration_dictionary` [GH-9945]
  + `huaweicloud_secmaster_create_retry_policy` [GH-9989]
  + `huaweicloud_secmaster_delete_nodes` [GH-9924]
  + `huaweicloud_secmaster_layout_wizard` [GH-9856]
  + `huaweicloud_secmaster_layout` [GH-9856]
  + `huaweicloud_secmaster_metric` [GH-9865]
  + `huaweicloud_secmaster_node_expansion` [GH-9913]
  + `huaweicloud_secmaster_pipe` [GH-9856]
  + `huaweicloud_secmaster_security_report` [GH-9856]
  + `huaweicloud_secmaster_siem_shipper` [GH-9931]
  + `huaweicloud_secmaster_soc_preprocess_rule` [GH-9856]
  + `huaweicloud_taurusdb_htap_starrocks_lts_config` [GH-10031]
  + `huaweicloud_taurusdb_htap_starrocks_replication_pause` [GH-9970]
  + `huaweicloud_taurusdb_htap_starrocks_replication_resume` [GH-9970]
  + `huaweicloud_taurusdb_htap_starrocks_replication` [GH-9920]
  + `huaweicloud_taurusdb_htap_starrocks_user` [GH-9904]

* **New Data Source:**
  + `huaweicloud_das_slow_log_exported_tasks` [GH-9930]
  + `huaweicloud_das_slow_log_templates` [GH-9915]
  + `huaweicloud_dataarts_factory_alarm_records` [GH-9917]
  + `huaweicloud_dataarts_security_datasource_permissions` [GH-9914]
  + `huaweicloud_dataarts_security_datasource_urls` [GH-9942]
  + `huaweicloud_dms_kafka_recycle_instances` [GH-9927]
  + `huaweicloud_dms_rocketmq_recycle_instances` [GH-9932]
  + `huaweicloud_gaussdb_data_disk_space_usage` [GH-9988]
  + `huaweicloud_gaussdb_database_storage_usage` [GH-9990]
  + `huaweicloud_gaussdb_dr_operation_records` [GH-9928]
  + `huaweicloud_gaussdb_instance_database_accounts` [GH-9998]
  + `huaweicloud_gaussdb_instance_database_roles` [GH-10017]
  + `huaweicloud_gaussdb_instance_database_tables` [GH-10029]
  + `huaweicloud_gaussdb_instance_lts_log_configs` [GH-9960]
  + `huaweicloud_gaussdb_remaining_quotas` [GH-9935]
  + `huaweicloud_gaussdb_schemas_storage_usage` [GH-9991]
  + `huaweicloud_gaussdb_sql_execution_plan_status` [GH-9963]
  + `huaweicloud_gaussdb_sql_patch` [GH-9962]
  + `huaweicloud_gaussdb_sql_text_schema_table` [GH-9964]
  + `huaweicloud_gaussdb_table_definition` [GH-9965]
  + `huaweicloud_gaussdb_tables_storage_usage` [GH-9992]
  + `huaweicloud_gaussdb_top_twenty_tables_storage_usage` [GH-9994]
  + `huaweicloud_geminidb_big_keys` [GH-9923]
  + `huaweicloud_geminidb_configuration_datastores` [GH-9972]
  + `huaweicloud_geminidb_high_risk_commands` [GH-9958]
  + `huaweicloud_geminidb_hot_keys` [GH-9916]
  + `huaweicloud_geminidb_instances_by_tags` [GH-10002]
  + `huaweicloud_geminidb_instances` [GH-9966]
  + `huaweicloud_geminidb_parameter_templates` [GH-10026]
  + `huaweicloud_geminidb_project_tags` [GH-10020]
  + `huaweicloud_geminidb_pt_application_records` [GH-9981]
  + `huaweicloud_geminidb_redis_slow_logs` [GH-10039]
  + `huaweicloud_geminidb_scheduled_tasks` [GH-9912]
  + `huaweicloud_geminidb_slow_logs` [GH-9968]
  + `huaweicloud_secmaster_collect_configs` [GH-9918]
  + `huaweicloud_secmaster_nodes` [GH-9926]
  + `huaweicloud_secmaster_policy_records` [GH-10036]
  + `huaweicloud_secmaster_search_logs` [GH-9929]
  + `huaweicloud_secmaster_siem_shipper_authorizations` [GH-9931]
  + `huaweicloud_taurusdb_htap_starrocks_db_replication_config` [GH-9997]
  + `huaweicloud_taurusdb_htap_starrocks_error_logs` [GH-10035]
  + `huaweicloud_taurusdb_htap_starrocks_lts_configs` [GH-10031]
  + `huaweicloud_taurusdb_htap_starrocks_replication_config` [GH-9997]
  + `huaweicloud_taurusdb_htap_starrocks_replication_db_parameters` [GH-9920]
  + `huaweicloud_taurusdb_htap_starrocks_slow_logs` [GH-10034]
  + `huaweicloud_taurusdb_htap_starrocks_users` [GH-9904]
  + `huaweicloud_taurusdb_instance_associated_eip` [GH-10007]
  + `huaweicloud_taurusdb_tags` [GH-10003]

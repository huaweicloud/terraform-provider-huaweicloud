...
func Get(client *golangsdk.ServiceClient, ns string) (r GetResult) {
	_, r.Err = client.Get(resourceURL(client, ns), &r.Body, nil)
	return
}
...
func Delete(client *golangsdk.ServiceClient, ns string) (r DeleteResult) {
	_, r.Err = client.Delete(resourceURL(client, ns), nil)
	return
}

...
// UpdateDeviceAuthorizerResponse Response Object
type UpdateDeviceAuthorizerResponse struct {
...
func (o UpdateDeviceAuthorizerResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateDeviceAuthorizerResponse struct{}"
	}

	return strings.Join([]string{"UpdateDeviceAuthorizerResponse", string(data)}, " ")
}

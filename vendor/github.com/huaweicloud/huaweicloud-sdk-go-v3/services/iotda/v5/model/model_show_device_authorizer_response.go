...
// ShowDeviceAuthorizerResponse Response Object
type ShowDeviceAuthorizerResponse struct {
...
func (o ShowDeviceAuthorizerResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowDeviceAuthorizerResponse struct{}"
	}

	return strings.Join([]string{"ShowDeviceAuthorizerResponse", string(data)}, " ")
}

...
// ShowProvisioningTemplateResponse Response Object
type ShowProvisioningTemplateResponse struct {
...
func (o ShowProvisioningTemplateResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowProvisioningTemplateResponse struct{}"
	}

	return strings.Join([]string{"ShowProvisioningTemplateResponse", string(data)}, " ")
}

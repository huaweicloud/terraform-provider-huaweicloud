...
// UpdateDeviceAuthorizer 更新自定义鉴权请求体。
type UpdateDeviceAuthorizer struct {
...
func (o UpdateDeviceAuthorizer) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateDeviceAuthorizer struct{}"
	}

	return strings.Join([]string{"UpdateDeviceAuthorizer", string(data)}, " ")
}

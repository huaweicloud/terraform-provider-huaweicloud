...
type ListPolicyRoleResult struct {
...
func (o ListPolicyRoleResult) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListPolicyRoleResult struct{}"
	}

	return strings.Join([]string{"ListPolicyRoleResult", string(data)}, " ")
}
